...
citycodes["ABC"] = [ "ES", 0.000000, 0.000000 ];
...
citycodes["BJS"] = [ "CN", 40.066667, 116.600000 ];
citycodes["BJS"] = [ "CN", 40.075000, 116.590000 ];
...
citycodes["BRQ"] = [ "AT", 48.216667, 16.333333 ];
...
citycodes["CGN"] = [ "DE", 50.800000, 7.066667 ];
...
citycodes["CXH"] = [ "CA", 49.300000, -123.133333 ];
...
citycodes["DFW"] = [ "US", 32.968558, -96.836447 ];
...
citycodes["DOM"] = [ "DM", 15.336111, -61.400556 ];
...
citycodes["EAL"] = [ "  ", 0.001111, 960.000000 ];
...
citycodes["HOU"] = [ "US", 29.722222, -95.588056 ];
...
citycodes["LEN"] = [ "ES", 0.000000, 0.000000 ];
...
citycodes["LON"] = [ "GB", 51.505278, 0.055278 ];
...
citycodes["LYS"] = [ "FR", 45.362944, 5.329375 ];
citycodes["LYS"] = [ "FR", 45.726386, 5.090833 ];
...
citycodes["MIL"] = [ "IT", 45.673889, 9.704167 ];
...
citycodes["MNL"] = [ "PH", 7.261253, 124.848100 ];
...
citycodes["MQP"] = [ "ZA", 0.000000, 0.000000 ];
...
citycodes["MSQ"] = [ "BY", 53.864472, 27.539683 ];
citycodes["MSQ"] = [ "BY", 53.865000, 27.541667 ];
...
citycodes["NAJ"] = [ "AZ", 0.000000, 0.000000 ];
...
citycodes["NRN"] = [ "DE", 0.000000, 0.000000 ];
...
citycodes["NTL"] = [ "AU", -32.796389, 151.833333 ];
citycodes["NTL"] = [ "AU", -33.000000, 151.916667 ];
citycodes["NTN"] = [ "AU", -17.666667, 141.070000 ];
citycodes["NTY"] = [ "ZA", -25.333822, 27.173358 ];
citycodes["NUE"] = [ "DE", 0.000000, 0.000000 ];
...
citycodes["NYC"] = [ "US", 40.639750, -73.778925 ];
...
citycodes["PHF"] = [ "US", 37.082881, -76.360547 ];
citycodes["PHF"] = [ "US", 37.131894, -76.492989 ];
...
citycodes["SAN"] = [ "US", 33.128156, -117.280133 ];
...
citycodes["SDJ"] = [ "JP", 23.151850, -109.721044 ];
...
citycodes["SNA"] = [ "US", 40.199167, -87.595833 ];
...
citycodes["TLV"] = [ "IL", 32.009500, 34.876897 ];
citycodes["TLV"] = [ "IL", 32.114661, 34.782239 ];
...
citycodes["VCE"] = [ "IT", 45.505142, 12.351883 ];
citycodes["VCE"] = [ "IT", 45.648869, 12.195361 ];
...
citycodes["VPS"] = [ "US", 30.482972, -86.525400 ];
citycodes["VPS"] = [ "US", 30.651858, -86.523286 ];
citycodes["VQS"] = [ "PR", 18.114167, -65.422500 ];
citycodes["VRA"] = [ "CU", 23.034444, -81.435278 ];
citycodes["VRK"] = [ "FI", 62.171111, 27.868611 ];
citycodes["VRN"] = [ "IT", 45.395964, 10.887194 ];
citycodes["VRN"] = [ "IT", 45.429075, 10.330633 ];
...
citycodes["WAS"] = [ "US", 38.852083, -77.037722 ];
...
citycodes["YAO"] = [ "CM", 3.717222, 11.552500 ];
...
citycodes["YNY"] = [ "KR", 0.000000, 0.000000 ];
...
citycodes["YVR"] = [ "CA", 49.195000, -123.181944 ];
citycodes["YVR"] = [ "CA", 49.300000, -123.133333 ];
...
citycodes["YYJ"] = [ "CA", 48.655000, -123.466667 ];
