...
citycodes["ACE"] = [ "ES-CN", 28.945464, -13.605225 ];
...
citycodes["ADK"] = [ "US-AK", 51.877964, -176.646031 ];
citycodes["ADL"] = [ "AU", -34.945000, 138.530556 ];
citycodes["ADQ"] = [ "US-AK", 57.749967, -152.493856 ];
...
citycodes["ANC"] = [ "US-AK", 61.174361, -149.996361 ];
citycodes["ANF"] = [ "CL", -23.444478, -70.445100 ];
citycodes["ANG"] = [ "FR", 45.729247, 0.221456 ];
citycodes["ANI"] = [ "US-AK", 61.581586, -159.543047 ];
...
citycodes["BEG"] = [ "RS", 44.818444, 20.309139 ];
...
citycodes["BET"] = [ "US-AK", 60.779778, -161.837997 ];
...
citycodes["BON"] = [ "BQ", 12.139444, -68.277222 ];
...
citycodes["BRW"] = [ "US-AK", 71.285447, -156.766003 ];
...
citycodes["CUR"] = [ "CW", 12.191944, -68.956944 ];
...
citycodes["CYF"] = [ "US-AK", 60.149225, -164.285633 ];
...
citycodes["DLG"] = [ "US-AK", 59.045414, -158.503339 ];
...
citycodes["DUT"] = [ "US-AK", 53.895833, -166.538889 ];
...
citycodes["EEK"] = [ "US-AK", 60.215906, -162.005608 ];
...
citycodes["ENA"] = [ "US-AK", 60.573111, -151.245000 ];
...
citycodes["EUX"] = [ "BQ", 17.491667, -62.975556 ];
...
citycodes["FAI"] = [ "US-AK", 64.815114, -147.856267 ];
...
citycodes["FNC"] = [ "PT-20", 32.694167, -16.778056 ];
...
citycodes["FUE"] = [ "ES-CN", 28.452717, -13.863761 ];
...
citycodes["GNU"] = [ "US-AK", 59.117275, -161.581397 ];
...
citycodes["GST"] = [ "US-AK", 58.424381, -135.707381 ];
...
citycodes["HNL"] = [ "US-HI", 21.318692, -157.922408 ];
citycodes["HOF"] = [ "SA", 25.332222, 49.596389 ];
citycodes["HOG"] = [ "CU", 20.785556, -76.315000 ];
citycodes["HOM"] = [ "US-AK", 59.645556, -151.476583 ];
...
citycodes["HPB"] = [ "US-AK", 61.524183, -166.146781 ];
...
citycodes["ILI"] = [ "US-AK", 59.753800, -154.910961 ];
...
citycodes["ITO"] = [ "US-HI", 19.721375, -155.048469 ];
...
citycodes["JHM"] = [ "US-HI", 20.962936, -156.673031 ];
...
citycodes["JNU"] = [ "US-AK", 58.354972, -134.576278 ];
...
citycodes["KKH"] = [ "US-AK", 59.959506, -162.881722 ];
...
citycodes["KTN"] = [ "US-AK", 55.355556, -131.713750 ];
...
citycodes["KWK"] = [ "US-AK", 59.876447, -163.167558 ];
citycodes["KWL"] = [ "CN", 25.218003, 110.039300 ];
citycodes["KWM"] = [ "AU", -15.486111, 141.749444 ];
citycodes["KWN"] = [ "US-AK", 59.757008, -161.879481 ];
...
citycodes["LIH"] = [ "US-HI", 21.975983, -159.338958 ];
...
citycodes["LNY"] = [ "US-HI", 20.785611, -156.951419 ];
...
citycodes["LPA"] = [ "ES-CN", 27.931886, -15.386586 ];
...
citycodes["MCG"] = [ "US-AK", 62.952875, -155.605764 ];
...
citycodes["MKK"] = [ "US-HI", 21.152886, -157.096256 ];
...
citycodes["MYU"] = [ "US-AK", 60.371419, -166.270608 ];
...
citycodes["NME"] = [ "US-AK", 60.470328, -164.685642 ];
...
citycodes["OGG"] = [ "US-HI", 20.898650, -156.430458 ];
...
citycodes["OME"] = [ "US-AK", 64.512203, -165.445247 ];
...
citycodes["OOK"] = [ "US-AK", 60.533378, -165.113964 ];
...
citycodes["OTZ"] = [ "US-AK", 66.884678, -162.598550 ];
...
citycodes["PDL"] = [ "PT-30", 37.741183, -25.697869 ];
...
citycodes["PTU"] = [ "US-AK", 59.011356, -161.819667 ];
...
citycodes["SAB"] = [ "BQ", 17.644444, -63.222222 ];
...
citycodes["SBH"] = [ "BL", 17.904444, -62.843611 ];
...
citycodes["SCC"] = [ "US-AK", 70.194756, -148.465161 ];
citycodes["SCE"] = [ "US", 40.793333, -77.860278 ];
citycodes["SCL"] = [ "CL", -33.392975, -70.785803 ];
citycodes["SCM"] = [ "US-AK", 61.844542, -165.573750 ];
...
citycodes["SDP"] = [ "US-AK", 55.315000, -160.517667 ];
...
citycodes["SFG"] = [ "MF", 18.099914, -63.047197 ];
...
citycodes["SIT"] = [ "US-AK", 57.047139, -135.361600 ];
...
citycodes["SNP"] = [ "US-AK", 57.167333, -170.220444 ];
...
citycodes["SPC"] = [ "ES-CN", 28.626478, -17.755611 ];
...
citycodes["STG"] = [ "US-AK", 56.345833, -169.841667 ];
...
citycodes["SXM"] = [ "SX", 18.040953, -63.108900 ];
...
citycodes["TER"] = [ "PT-30", 38.761842, -27.090797 ];
citycodes["TEX"] = [ "US", 37.953758, -107.908481 ];
citycodes["TFN"] = [ "ES-CN", 28.482653, -16.341536 ];
citycodes["TFS"] = [ "ES-CN", 28.044475, -16.572489 ];
citycodes["TGD"] = [ "ME", 42.359394, 19.251878 ];
...
citycodes["TIV"] = [ "ME", 42.404664, 18.723286 ];
...
citycodes["TNK"] = [ "US-AK", 60.575597, -165.273128 ];
...
citycodes["UNK"] = [ "US-AK", 63.888358, -160.798953 ];
...
citycodes["VAK"] = [ "US-AK", 61.533636, -165.583733 ];
...
citycodes["VDZ"] = [ "US-AK", 61.133950, -146.248342 ];
...
citycodes["WRG"] = [ "US-AK", 56.484325, -132.369825 ];
...
citycodes["WTL"] = [ "US-AK", 60.335344, -162.667008 ];
...
citycodes["WWT"] = [ "US-AK", 60.940878, -164.643992 ];
...
citycodes["YAK"] = [ "US-AK", 59.503306, -139.660250 ];
